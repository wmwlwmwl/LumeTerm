...
export const APP_GITHUB_REPO_URL = 'https://github.com/wmwlwmwl/LumeTerm';
...
export const APP_GITHUB_ANDROID_REPO_URL = 'https://github.com/wmwlwmwl/LumeTerm-Android';
